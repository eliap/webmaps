...
var format_Moystonlongtermsites_fulcrum_5 = new ol.format.GeoJSON();
var features_Moystonlongtermsites_fulcrum_5 = format_Moystonlongtermsites_fulcrum_5.readFeatures(json_Moystonlongtermsites_fulcrum_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Moystonlongtermsites_fulcrum_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Moystonlongtermsites_fulcrum_5.addFeatures(features_Moystonlongtermsites_fulcrum_5);
var lyr_Moystonlongtermsites_fulcrum_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Moystonlongtermsites_fulcrum_5, 
                style: style_Moystonlongtermsites_fulcrum_5,
                popuplayertitle: 'Moyston long term sites_fulcrum',
                interactive: true,
                title: '<img src="styles/legend/Moystonlongtermsites_fulcrum_5.png" /> Moyston long term sites_fulcrum'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_Googlesatellite_1.setVisible(true);lyr_CrownlandparksreservesDEECAlayer_2.setVisible(true);lyr_AllUpperWimmeraLandcares_3.setVisible(true);lyr_AllPPhistoricrevegpre2025_Fixedgeometries_4.setVisible(true);lyr_Moystonlongtermsites_fulcrum_5.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Googlesatellite_1,lyr_CrownlandparksreservesDEECAlayer_2,lyr_AllUpperWimmeraLandcares_3,lyr_AllPPhistoricrevegpre2025_Fixedgeometries_4,lyr_Moystonlongtermsites_fulcrum_5];
...
lyr_Moystonlongtermsites_fulcrum_5.set('fieldAliases', {'fulcrum_id': 'fulcrum_id', 'created_at': 'created_at', 'updated_at': 'updated_at', 'created_by': 'created_by', 'updated_by': 'updated_by', 'system_created_at': 'system_created_at', 'system_updated_at': 'system_updated_at', 'version': 'version', 'status': 'status', 'project': 'project', 'assigned_to': 'assigned_to', 'latitude': 'latitude', 'longitude': 'longitude', 'site_name': 'site_name', 'site_type': 'site_type', 'site_type_other': 'site_type_other', 'site_landcare_group': 'site_landcare_group', 'site_estdate': 'site_estdate', 'site_description': 'site_description', 'site_initial_goals': 'site_initial_goals', 'site_manager_name': 'site_manager_name', 'site_manager_number': 'site_manager_number', 'site_planted_species': 'site_planted_species', 'site_weed_priority': 'site_weed_priority', 'polygon_points': 'polygon_points', 'gps_altitude': 'gps_altitude', 'gps_horizontal_accuracy': 'gps_horizontal_accuracy', 'gps_vertical_accuracy': 'gps_vertical_accuracy', 'gps_speed': 'gps_speed', 'gps_course': 'gps_course', });
...
lyr_Moystonlongtermsites_fulcrum_5.set('fieldImages', {'fulcrum_id': 'TextEdit', 'created_at': 'DateTime', 'updated_at': 'DateTime', 'created_by': 'TextEdit', 'updated_by': 'TextEdit', 'system_created_at': 'DateTime', 'system_updated_at': 'DateTime', 'version': 'Range', 'status': 'TextEdit', 'project': 'TextEdit', 'assigned_to': 'TextEdit', 'latitude': 'TextEdit', 'longitude': 'TextEdit', 'site_name': 'TextEdit', 'site_type': 'TextEdit', 'site_type_other': 'TextEdit', 'site_landcare_group': 'TextEdit', 'site_estdate': 'DateTime', 'site_description': 'TextEdit', 'site_initial_goals': 'TextEdit', 'site_manager_name': 'TextEdit', 'site_manager_number': 'TextEdit', 'site_planted_species': 'TextEdit', 'site_weed_priority': 'TextEdit', 'polygon_points': 'TextEdit', 'gps_altitude': 'TextEdit', 'gps_horizontal_accuracy': 'TextEdit', 'gps_vertical_accuracy': 'TextEdit', 'gps_speed': 'TextEdit', 'gps_course': 'TextEdit', });
...
lyr_Moystonlongtermsites_fulcrum_5.set('fieldLabels', {'fulcrum_id': 'hidden field', 'created_at': 'hidden field', 'updated_at': 'hidden field', 'created_by': 'hidden field', 'updated_by': 'hidden field', 'system_created_at': 'hidden field', 'system_updated_at': 'hidden field', 'version': 'hidden field', 'status': 'hidden field', 'project': 'hidden field', 'assigned_to': 'hidden field', 'latitude': 'hidden field', 'longitude': 'hidden field', 'site_name': 'inline label - always visible', 'site_type': 'inline label - always visible', 'site_type_other': 'hidden field', 'site_landcare_group': 'hidden field', 'site_estdate': 'inline label - always visible', 'site_description': 'inline label - always visible', 'site_initial_goals': 'inline label - always visible', 'site_manager_name': 'hidden field', 'site_manager_number': 'hidden field', 'site_planted_species': 'hidden field', 'site_weed_priority': 'hidden field', 'polygon_points': 'hidden field', 'gps_altitude': 'hidden field', 'gps_horizontal_accuracy': 'hidden field', 'gps_vertical_accuracy': 'hidden field', 'gps_speed': 'hidden field', 'gps_course': 'hidden field', });
lyr_Moystonlongtermsites_fulcrum_5.on('precompose', function(evt) {
