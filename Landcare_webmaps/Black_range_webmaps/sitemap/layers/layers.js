...
var format_BlackRangelongtermsites_fulcrum_5 = new ol.format.GeoJSON();
var features_BlackRangelongtermsites_fulcrum_5 = format_BlackRangelongtermsites_fulcrum_5.readFeatures(json_BlackRangelongtermsites_fulcrum_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BlackRangelongtermsites_fulcrum_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BlackRangelongtermsites_fulcrum_5.addFeatures(features_BlackRangelongtermsites_fulcrum_5);
var lyr_BlackRangelongtermsites_fulcrum_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BlackRangelongtermsites_fulcrum_5, 
                style: style_BlackRangelongtermsites_fulcrum_5,
                popuplayertitle: 'Black Range long term sites_fulcrum',
                interactive: true,
                title: '<img src="styles/legend/BlackRangelongtermsites_fulcrum_5.png" /> Black Range long term sites_fulcrum'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_Googlesatellite_1.setVisible(true);lyr_CrownlandparksreservesDEECAlayer_2.setVisible(true);lyr_AllUpperWimmeraLandcares_3.setVisible(true);lyr_AllPPhistoricrevegpre2025_Fixedgeometries_4.setVisible(true);lyr_BlackRangelongtermsites_fulcrum_5.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Googlesatellite_1,lyr_CrownlandparksreservesDEECAlayer_2,lyr_AllUpperWimmeraLandcares_3,lyr_AllPPhistoricrevegpre2025_Fixedgeometries_4,lyr_BlackRangelongtermsites_fulcrum_5];
...
lyr_BlackRangelongtermsites_fulcrum_5.set('fieldAliases', {'fulcrum_id': 'fulcrum_id', 'created_at': 'created_at', 'updated_at': 'updated_at', 'created_by': 'created_by', 'updated_by': 'updated_by', 'system_created_at': 'system_created_at', 'system_updated_at': 'system_updated_at', 'version': 'version', 'status': 'status', 'project': 'project', 'assigned_to': 'assigned_to', 'latitude': 'latitude', 'longitude': 'longitude', 'site_name': 'site_name', 'site_type': 'site_type', 'site_type_other': 'site_type_other', 'landcare_region': 'landcare_region', 'year_established': 'year_established', 'landholder_original': 'landholder_original', 'site_description': 'site_description', 'site_initial_goals': 'site_initial_goals', 'land_access_manager_name': 'land_access_manager_name', 'land_access_manager_number': 'land_access_manager_number', 'planted_species_list': 'planted_species_list', 'weed_priority_list': 'weed_priority_list', 'polygon_points': 'polygon_points', 'gps_altitude': 'gps_altitude', 'gps_horizontal_accuracy': 'gps_horizontal_accuracy', 'gps_vertical_accuracy': 'gps_vertical_accuracy', 'gps_speed': 'gps_speed', 'gps_course': 'gps_course', });
...
lyr_BlackRangelongtermsites_fulcrum_5.set('fieldLabels', {'fulcrum_id': 'hidden field', 'created_at': 'hidden field', 'updated_at': 'hidden field', 'created_by': 'hidden field', 'updated_by': 'hidden field', 'system_created_at': 'hidden field', 'system_updated_at': 'hidden field', 'version': 'hidden field', 'status': 'hidden field', 'project': 'hidden field', 'assigned_to': 'hidden field', 'latitude': 'hidden field', 'longitude': 'hidden field', 'site_name': 'inline label - always visible', 'site_type': 'inline label - always visible', 'site_type_other': 'hidden field', 'landcare_region': 'no label', 'year_established': 'no label', 'landholder_original': 'no label', 'site_description': 'inline label - always visible', 'site_initial_goals': 'inline label - always visible', 'land_access_manager_name': 'no label', 'land_access_manager_number': 'no label', 'planted_species_list': 'no label', 'weed_priority_list': 'no label', 'polygon_points': 'hidden field', 'gps_altitude': 'hidden field', 'gps_horizontal_accuracy': 'hidden field', 'gps_vertical_accuracy': 'hidden field', 'gps_speed': 'hidden field', 'gps_course': 'hidden field', });
lyr_BlackRangelongtermsites_fulcrum_5.on('precompose', function(evt) {
